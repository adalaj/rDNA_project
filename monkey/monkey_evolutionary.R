...
#visualisation is identical for KX065350 and KX065350_and_NR_146166
...
entire_g4s_rdna <- fread("pG4CS_KX065350_and_NR_146166_monkey_junctn_details.csv", header = TRUE, sep = ",")#114
...
rlfs<- fread("RLFS_KX065350_monkey_junctn_details.csv", header = TRUE, sep = ",")#131
...
imotif<- fread("monkey_imotif_5ets_KX065350_3ets_prediction_end_to_end_prediction_default_setting_master.csv", header = TRUE, sep = ",")#53
...
for (i in names(template_filt_datasets)[1:2]){
  ...
  kpRect(kp, chr = 'KX065350', x0 = 1, x1 = 3640 , y0 = 0, y1 = 1, col = "#FDCCE5", data.panel = "ideogram") #marks 5'ETS
  #5001+(3640-1) = 9007
  
  kpRect(kp, chr = 'KX065350', x0 = 3641, x1 = 5508, y0 = 0, y1 = 1, col = "#D0B6FF", data.panel = "ideogram") #marks 18S
  #9008+(1870-1) = 10877
  
  kpRect(kp, chr = 'KX065350', x0 = 5509, x1 = 6535, y0 = 0, y1 = 1, col = "#EF9B20", data.panel = "ideogram") #marks ITS1
  #10877+(1000-1) = 11877
  
  kpRect(kp, chr = 'KX065350', x0 = 6536, x1 = 6692 , y0 = 0, y1 = 1, col = "#A0322B", data.panel = "ideogram") #marks 5.8S
  #11878+(157-1) = 12034
  
  kpRect(kp, chr = 'KX065350', x0 = 6693, x1 = 7863, y0 = 0, y1 = 1, col = "#FFCC17", data.panel = "ideogram") #marks ITS2
  #12035+(1088-1) = 13122
  
  kpRect(kp, chr = 'KX065350', x0 = 7864 , x1 = 12648, y0 = 0, y1 = 1, col = "#E5FFB6", data.panel = "ideogram") #marks 28S
  #13123+(4730-1)= 17852
...
# make new for KX065350_and_NR_146166, custom genome to 12980
  ...
  setwd("/Users/jyotiadala/Library/CloudStorage/OneDrive-SUNYUpstateMedicalUniversity/project/bruce_lab/project/rDNA/rloop_and_rdna/monkey")
  rlfs<- fread("RLFS_KX065350_and_NR_146166_monkey_junctn_details.csv", header = TRUE, sep = ",")
  rlfs<- rlfs %>% select(GenBank_Accession, actual_rlfs_start, actual_rlfs_end, rDNA_region, strand)
  
  
  setwd("/Users/jyotiadala/Library/CloudStorage/OneDrive-SUNYUpstateMedicalUniversity/project/bruce_lab/project/rDNA/imotif/monkey")
  imotif<- fread("monkey_imotif_5ets_KX065350_and_NR_146166_3ets_prediction_end_to_end_prediction_default_setting_master.csv", header = TRUE, sep = ",")
  imotif<- imotif %>% select(chr, actual_imotif_start, actual_imotif_end, rDNA_region, strand)
  ...
  for (i in names(datasets)) {
    filt <- datasets[[i]] 
      colnames(filt)<- c("chr", "actual_start", "actual_end", "rDNA_region", "strand")
      filt$chr<- "KX065350_and_NR_146166"
      filt$name<- i
      filt$score<- 0
      filt<- filt %>% select(chr, actual_start, actual_end, name, score, strand)
      filt<- filt %>% mutate(start = ifelse(filt$strand == "+", actual_start, actual_end))
  ...
  for (i in names(template_filt_datasets)[1:2]){
    ...
    kpRect(kp, chr = 'KX065350_and_NR_146166', x0 = 1, x1 = 3640 , y0 = 0, y1 = 1, col = "#FDCCE5", data.panel = "ideogram") #marks 5'ETS
    #5001+(3640-1) = 9007
    
    kpRect(kp, chr = 'KX065350_and_NR_146166', x0 = 3641, x1 = 5508, y0 = 0, y1 = 1, col = "#D0B6FF", data.panel = "ideogram") #marks 18S
    #9008+(1870-1) = 10877
    
    kpRect(kp, chr = 'KX065350_and_NR_146166', x0 = 5509, x1 = 6535, y0 = 0, y1 = 1, col = "#EF9B20", data.panel = "ideogram") #marks ITS1
    #10877+(1000-1) = 11877
    
    kpRect(kp, chr = 'KX065350_and_NR_146166', x0 = 6536, x1 = 6692 , y0 = 0, y1 = 1, col = "#A0322B", data.panel = "ideogram") #marks 5.8S
    #11878+(157-1) = 12034
    
    kpRect(kp, chr = 'KX065350_and_NR_146166', x0 = 6693, x1 = 7863, y0 = 0, y1 = 1, col = "#FFCC17", data.panel = "ideogram") #marks ITS2
    #12035+(1088-1) = 13122
    
    kpRect(kp, chr = 'KX065350_and_NR_146166', x0 = 7864 , x1 = 12648, y0 = 0, y1 = 1, col = "#E5FFB6", data.panel = "ideogram") #marks 28S
    #13123+(4730-1)= 17852

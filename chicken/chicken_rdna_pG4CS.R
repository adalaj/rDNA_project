## ##plotting pG4CS in chicken rDNA locus that has new promoter size of 3000. 
## here IGS on start and promoter at end.


#open terminal
#(base) jyotiadala@Jyotis-MacBook-Pro Downloads % conda activate python3.11
#(python3.11) jyotiadala@Jyotis-MacBook-Pro Downloads % python g4_canonical_finder_3.11python.py  KT445934_chicken_rDNA_2017.fasta > output_pG4CS_KT445934_chicken_rDNA_2017.txt
...
entire_rdna<- fread("output_pG4CS_KT445934_chicken_rDNA_2017.txt", sep = "\t", header = FALSE) #65
...
kpRect(kp, chr = 'rDNA_locus', x0 = 1, x1 = 1836 , y0 = 0, y1 = 1, col = "#FDCCE5", data.panel = "ideogram") #marks 5'ETS
kpRect(kp, chr = 'rDNA_locus', x0 = 1837, x1 = 3659, y0 = 0, y1 = 1, col = "#D0B6FF", data.panel = "ideogram") #marks 18S
...
##basically input file will be output_pG4CS_KT445934_chicken_rDNA_2017.txt
...
entire_g4s_rdna<- fread("output_pG4CS_KT445934_chicken_rDNA_2017.txt", sep = "\t", header = FALSE) #65
...
entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start > 1836 ] <- "5'ETS and 18S junction"

entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start >= 1837] <- "18S"
entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start > 3659 ] <- "18S and ITS1 junction"


entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start >= 3660   ] <- "ITS1"
entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start > 6189] <- "ITS1 and 5.8S junction"

entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start >= 6190 ] <- "5.8S"
entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start > 6346 ] <- "5.8S and ITS2 junction"

entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start >= 6347] <- "ITS2"
entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start > 7079] <- "ITS2 and 28S junction"

entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start >= 7080 ] <- "28S"
entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start > 11520 ] <- "28S and 3'ETS junction"

entire_g4s_rdna$rDNA_region[entire_g4s_rdna$actual_pG4CS_start >= 11521] <- "3'ETS"


fwrite(entire_g4s_rdna, "pG4CS_KT445934_chicken_junctn_details.csv", sep = ",")
...
fwrite(entire_g4s_rdna_summary, "pG4CS_KT445934_chicken_at_junctn_graphinput.csv", sep = ",")
...
g4s_norm<- ggplot(entire_g4s_rdna_summary, aes(x= rDNA_region, y = norm_pG4CS_count, fill= rDNA_region)) + 
  ...
  labs(title= "Normalized pG4CS distribution in the chicken rDNA locus", 
...
ggsave( "Normalized_pG4CS_distribution_in_chicken_rDNA_subcomponents_incld_junctn_AR.tiff", 
...
ggsave("Normalized_pG4CS_distribution_in_chicken_rDNA_subcomponents_after_rule.tiff", 
...
fwrite(entire_g4s_rdna_summary2, "pG4CS_KT445934_chicken_no_junctn_strandwise_AR_graphinput.csv")


g4s_strandwise<- ggplot(entire_g4s_rdna_summary2, aes(x= rDNA_region, y = norm_pG4CS_count, fill= strand)) + 
  geom_bar(stat= "identity", position ="dodge", color = "black") +
  labs(title= "Normalized pG4CS strandwise distribution in the chicken rDNA locus", 
       x= "Chicken rDNA region", 
       y= "Normalized pG4CS count", 
       fill= "pG4CS strand")+
...
ggsave( "Normalized_strandwise_pG4CS_distribution_in_chicken_rDNA_subcomponents_AR.tiff", 
...
g4s_nontemplate <- ggplot(nontemplate, aes(x= rDNA_region, y = norm_pG4CS_count, fill= rDNA_region)) + 
  geom_bar(stat= "identity", position ="dodge", color = "black") +
  labs(title= "Normalized Non-template pG4CS distribution in the chicken rDNA locus", 
       x= "Chicken rDNA region", 
...
ggsave( "Normalized_nontemplate_pG4CS_distribution_in_chicken_rDNA_subcomponents_AR.tiff", 
...
g4s_template <- ggplot(template, aes(x= rDNA_region, y = norm_pG4CS_count, fill= rDNA_region)) + 
  geom_bar(stat= "identity", position ="dodge", color = "black") +
  labs(title= "Normalized Template pG4CS distribution in the chicken rDNA locus", 
       x= "Chicken rDNA region", 
...
ggsave( "Normalized_template_pG4CS_distribution_in_chicken_rDNA_subcomponents_AR.tiff", 

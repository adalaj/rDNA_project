...
chicken_rDNA<- readDNAStringSet(file = "KT445934_chicken_rDNA_2017.fasta") #belongs to package BIOSTRINGS
...
# I added KT445934_5ets_to_3ets_nontemplate.fasta to predict>upload DNA FILE (FASTA FORMAT) (https://im-seeker.org/predict)>continue>end to end with default model>predict
# I got a csv file which i saved as chicken_imotif_prediction_end_to_end_default_setting_nontemplate.csv

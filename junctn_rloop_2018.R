...
entire_RLFSs_rdna <- entire_RLFSs_rdna %>% filter(entire_RLFSs_rdna$V2<46137) #195
                            
entire_RLFSs_rdna$v7 <- "junction"

entire_RLFSs_rdna$v8<- entire_RLFSs_rdna$V2-entire_RLFSs_rdna$V2

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 1298 & entire_RLFSs_rdna$V2 < 3500] <- "Promoter"
...
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 7157 ] <- "5'ETS and 18S junction"

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 >= 7158 ] <- "18S"
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 9026 ] <- "18S and ITS1 junction"


entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 >= 9027  ] <- "ITS1"
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 10096] <- "ITS1 and 5.8S junction"

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 >= 10097 ] <- "5.8S"
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 10253 ] <- "5.8S and ITS2 junction"

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 >= 10254] <- "ITS2"
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 11420 ] <- "ITS2 and 28S junction"

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 >= 11421 ] <- "28S"
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 16471 ] <- "28S and 3'ETS junction"

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 >= 16472 ] <- "3'ETS"
entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 16832 ] <- "3'ETS and IGS junction"

entire_RLFSs_rdna$v7[entire_RLFSs_rdna$V2 > 16833 & entire_RLFSs_rdna$V2 < 46137] <- "IGS"
...
fwrite(entire_RLFSs_rdna, "RLFS_KY962518_added_3500nt_IGS_upstream_at_junctn_details.csv", sep = ",")
...
entire_RLFSs_rdna_summary <- entire_RLFSs_rdna_summary[c(7,8,3,9,10,11,5,12,13,14,6,15, 1,16,2,17,4),]
...
fwrite(entire_RLFSs_rdna_summary, "RLFS_KY962518_added_3500nt_IGS_upstream_at_junctn_graphinput.csv", sep = ",")
...
ggsave( "Normalized_RLFS_distribution_in_human_rDNA_subcomponents_incld_junctn_after_rule.tiff", 
...
new_rows<- data.table(rDNA_region = c( "18S","18S", "5.8S","5.8S"),
                      strand= c("+", "-", "+", "-"),
                      RLFS_count = c(0,0,0,0))
...
fwrite(entire_RLFSs_rdna_summary2, "RLFS_KY962518_added_3500nt_IGS_upstream_no_junctn_strandwise_graphinput.csv")
...
ggsave( "Normalized_strandwise_RLFS_distribution_in_human_rDNA_subcomponents_after_rule.tiff", 
